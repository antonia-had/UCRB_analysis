...
for i in range(len(axes.flat)):
    ...
    ax.scatter(CMIPsamples[:,top_predictors[0]][:112], CMIPsamples[:,top_predictors[1]][:112], c='#3C787E',edgecolor='none',s=50)
    ax.scatter(CMIPsamples[:,top_predictors[0]][112:], CMIPsamples[:,top_predictors[1]][112:], c='#D0CD94',edgecolor='none',s=50)
    ax.scatter(SOW_values[top_predictors[0]],SOW_values[top_predictors[1]], c='#305252',edgecolor='none',s=70)
fig.tight_layout()
fig.savefig('./Paper1_figures/Figure_8_'+design+'_contours_CMIPpoints.svg')
plt.close()

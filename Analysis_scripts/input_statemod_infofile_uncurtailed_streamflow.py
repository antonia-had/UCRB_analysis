...
for k in range(start, stop):
    for j in range(10): 
        ...
        f1.write(S1)    
        f1.close()
        writenewDDM([irrigation, transbasin], 779, [0, 2], k, j)
        ...
        while not (os.path.exists('./Experiment_files/cm2015B_S'+str(k+1)+ '_' + str(j+1) + '.xdd') and \
            ...
            time.sleep(1)
        getinfo(k,j)
        os.system("rm ./Experiment_files/cm2015B_S{0}_{1}.xdd ./Experiment_files/cm2015B_S{0}_{1}.xre ./Experiment_files/cm2015B_S{0}_{1}.xss ./Experiment_files/cm2015B_S{0}_{1}.xop ./Experiment_files/cm2015B_S{0}_{1}.xpl ./Experiment_files/cm2015B_S{0}_{1}.xca ./Experiment_files/cm2015B_S{0}_{1}.xrp ./Experiment_files/cm2015B_S{0}_{1}.b*".format(k+1,j+1))
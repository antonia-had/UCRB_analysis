...
for j in range(start, stop):
    ...
    while not (os.path.exists('./Experiment_files/cm2015B_S0_' + str(j+1) + '.xdd') and \
        ...
        time.sleep(1)
    getinfo(j)
    os.system("rm ./Experiment_files/cm2015B_S0_{}.xdd ./Experiment_files/cm2015B_S0_{}.xre ./Experiment_files/cm2015B_S0_{}.xss ./Experiment_files/cm2015B_S0_{}.b44 ./Experiment_files/cm2015B_S0_{}.b67 ./Experiment_files/cm2015B_S0_{}.b43".format(j+1))
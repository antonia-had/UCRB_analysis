...
for j in range(start, stop):
    ...
    while not (os.path.exists('./Experiment_files/cm2015B_S0_' + str(j+1) + '.xdd') and \
        ...
        time.sleep(1)
    getinfo(j)
    os.system("rm ./Experiment_files/cm2015B_S0_{}.xdd ./Experiment_files/cm2015B_S0_{}.xre ./Experiment_files/cm2015B_S0_{}.xss ./Experiment_files/cm2015B_S0_{}.xop ./Experiment_files/cm2015B_S0_{}.xpl ./Experiment_files/cm2015B_S0_{}.xca ./Experiment_files/cm2015B_S0_{}.xrp ./Experiment_files/cm2015B_S0_{}.xbe ./Experiment_files/cm2015B_S0_{}.xbg ./Experiment_files/cm2015B_S0_{}.xgn ./Experiment_files/cm2015B_S0_{}.b*".format(j+1))